...
-- Server title
Configuration.ServerTitle           = "[TY-PROJECT] - StarWars - EmpireRP"
...
Configuration.MainIcon              = Color( 255,255,255 )
...
-- Incognito text
Configuration.ActivateIncog         = "§"
Configuration.DeactivateIncog       = "!"
...
Configuration.CustomUserTag["STEAM_0:1:445279834"]       = { Tag = "Le Plus beau des bg", TagColor = Color( 255,255,255 ) }
...
Configuration.RankDisplay["user"]           = { DisplayName = "", TagName = "", DisplayColor = Color( 255,255,255 ), TagColor = Color( 121,122,123 ) }
Configuration.RankDisplay["VIP"]           = { DisplayName = "VIP", TagName = "VIP", DisplayColor = Color( 255,234,0 ), TagColor = Color( 255,234,0 ) }
Configuration.RankDisplay["Animateur"]           = { DisplayName = "Animateur", TagName = "ANIMATEUR", DisplayColor = Color( 200,255,0 ), TagColor = Color( 200,255,0 ) }
Configuration.RankDisplay["Moderateur"]          = { DisplayName = "Modérateur", TagName = "MODERATEUR", DisplayColor = Color( 43,255,0 ), TagColor = Color( 43,255,0 ) }  
Configuration.RankDisplay["Administrateur"]     = { DisplayName = "Administrateur", TagName = "ADMINISTRATEUR", DisplayColor = Color( 0,170,255 ), TagColor = Color( 0,170,255 ) }
Configuration.RankDisplay["superadmin"]      = { DisplayName = "Super administrateur", TagName = "SUPER ADMINISTRATEUR", DisplayColor = Color( 158,255,218 ), TagColor = Color( 158,255,218 ) }
Configuration.RankDisplay["Responsable Staff"]          = { DisplayName = "Responsable Staff", TagName = "RESPONSABLE", DisplayColor = Color( 255,0,0 ), TagColor = Color( 255,0,0  ) }
Configuration.RankDisplay["Responsable Serveur"]          = { DisplayName = "Responsable Serveur", TagName = "RESPONSABLES", DisplayColor = Color( 68,0,255 ), TagColor = Color( 68,0,255 ) }
...
Configuration.MenuAccess            = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
...
Configuration.AllowedGoto           = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
-- Who has access to bring
Configuration.AllowedBring         = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
-- Who has access to spectate
Configuration.AllowedSpectate       = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
-- Who has access to freeze
Configuration.AllowedFreeze         = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
-- Who has access to kick
Configuration.AllowedKick           = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
-- Who has access to ban
Configuration.AllowedBan            = { "Moderateur", "Administrateur", "superadmin", "Animateur" }
